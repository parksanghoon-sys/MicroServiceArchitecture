...
public class JwtTokenGenerator : IJwtTokenGenerator
{
    ...
    public async Task<TokenResponseDto> RefreshTokenAsync(ApplicationUser user, string token)
    {
        var authenticationModel = new TokenResponseDto();
        if(user is null)
        {
    ...
    private async Task<JwtSecurityToken> GenerateToken(ApplicationUser applicationUser)
    {
        ...
        var jwtSecurityToken = new JwtSecurityToken(
                            ...
                            claims: claims,
                            expires: DateTime.UtcNow.AddMinutes(_authenticationOptions.JwtOptions.AccessTokenExpirationMinutes),
