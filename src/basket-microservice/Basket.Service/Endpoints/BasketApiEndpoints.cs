...
public static class BsketApiEndpoints
{
    public static void RegisterEndpoints(this IEndpointRouteBuilder routeBuilder)
    {
        ...
        routeBuilder.MapPut("/{customerId}",
       ([FromServices] IBasketStore basketStore, string customerId, AddBasketProductRequest addProductRequest) =>
       {
           ...
           customerBasket.AddBasketProduct(new BasketProduct(addProductRequest.ProductId,
               addProductRequest.ProductName, addProductRequest.Quantity));
